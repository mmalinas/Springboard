...
if __name__ == '__main__':
	...
	doc = Predictor('all_posts_reddit_onionandnotonion_2.csv', [.1, 1, 5, 10, 50])
	clf, vectorizer = doc.train_and_fit()
	pickle_util.save_clf(clf)
	pickle_util.save_vectorizer(vectorizer)
	pickle_util.save_predictor(doc)
	print('success!')